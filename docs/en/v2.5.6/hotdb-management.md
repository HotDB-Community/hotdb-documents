...
![](media/image2.png){width="5.7625in" height="4.356944444444444in"}
...
![](media/image24.png){width="5.769444444444445in" height="3.154166666666667in"}
...
![](media/image41.png){width="5.7625in" height="2.776388888888889in"}
...
![](media/image65.png){width="5.769444444444445in" height="4.936805555555556in"}
...
![](media/image71.png){width="5.7625in" height="1.0138888888888888in"}
...
![](media/image88.png){width="2.636111111111111in" height="1.5034722222222223in"}
...
![](media/image98.png){width="5.7625in" height="2.692361111111111in"}
...
![](media/image111.png){width="5.769444444444445in" height="3.0in"}
...
- Click on the "TOP 10 Table Throughput Today" area to link to the "Compute Node Throughput" report details page; and click on the "TOP 10 Data Amount Table Today" area to link to the "Cluster Data Amount" report details page.
...
- Data Source: Display the total number of data sources, the number of data sources with normal or warning or failure status, and the data source with replication latency. The data is obtained from the "Logic Topological Graph".
...
![](media/image156.png){width="5.769444444444445in" height="2.1326388888888888in"}
...
![](media/image177.png){width="5.769444444444445in" height="3.3354166666666667in"}

Click "Modify Table Structure" to jump to "Online DDL" function page, and click "Modify Table Configuration" to jump to "Sharding Plan Online Modification" function page.

#### Table record export

![](media/image178.png){width="5.769444444444445in" height="2.678472222222222in"}

![](media/image179.png){width="5.7625in" height="2.321527777777778in"}
...
If the "Export Table Structure of Created Tables" is checked, the "Table structure details" column is automatically added to the exported content to display the "Create Table Statement" of the created table.

"Table structure details" in the export record is obtained by the display @\@ddl command in the compute node management port (3325), and the sharding table and the global table adopt the minimum DDL of DNID in the data node. If the current master 3325 port cannot be connected, the "Table Structure" and "Table structure details" are NULL.

#### Delete table

**Function Entry**: Select "Configuration" -\> "Table Configuration" -\> "Delete" on the Distributed Transactional Database Platform page.
...
![](media/image180.png){width="1.8319444444444444in" height="0.7902777777777777in"}
...
**Function Entry**: Select "Configuration" -\> "Sharding Function" on the Distributed Transactional Database Platform page.

**Seven sharding types are described in detail as follows**:

![](media/image182.png){width="5.7625in" height="3.7625in"}
...
**Step 2**: Select "MATCH" for "Sharding Type"
...
![](media/image183.png){width="5.7625in" height="0.30069444444444443in"}
...
![](media/image184.png){width="5.769444444444445in" height="1.1680555555555556in"}
...
![](media/image185.png){width="5.769444444444445in" height="4.790277777777778in"}

##### Add sharding function of MATCH type in manual setting mode {#add-sharding-function-of-match-type-in-manual-setting-mode .list-paragraph}
...
![](media/image186.png){width="5.7625in" height="2.8534722222222224in"}
...
**Step 2**: Select "RANGE" for "Sharding Type"
...
![](media/image187.png){width="5.769444444444445in" height="4.027777777777778in"}

##### Add sharding function of RANGE type in manual setting mode {#add-sharding-function-of-range-type-in-manual-setting-mode .list-paragraph}
...
![](media/image188.png){width="5.769444444444445in" height="2.545138888888889in"}
...
**Step 2**: Select "ROUTE" for "Sharding Type"
...
![](media/image189.png){width="5.7625in" height="4.636111111111111in"}
...
![](media/image190.png){width="5.7625in" height="2.657638888888889in"}
...
**Step 2**: Select "SIMPLE_MOD" for "Sharding Type"
...
![](media/image191.png){width="5.7625in" height="3.797222222222222in"}
...
![](media/image192.png){width="5.7555555555555555in" height="2.4756944444444446in"}
...
**Step 2**: Select "CRC32_MOD" for "Sharding Type"
...
![](media/image193.png){width="5.769444444444445in" height="3.671527777777778in"}
...
![](media/image194.png){width="5.7625in" height="2.5805555555555557in"}

Note: Manual setting of input values supports the input of multiple values which shall be spaced by English commas or English space

#### Edit sharding function

**Function Entry**: Select "Configuration" -\> "Sharding Function" -\> "Edit sharding function" on the Distributed Transactional Database Platform page.
...
![](media/image195.png){width="5.769444444444445in" height="2.363888888888889in"}
...
**Function Entry**: Select "Configuration" -\> "Sharding Function" -\> on the Distributed Transactional Database Platform page, and click "Delete" on the Sharding Function page.
...
![](media/image196.png){width="1.8604166666666666in" height="0.8180555555555555in"}

**Note**: The sharding function that has been cited by the table cannot be deleted.

#### Replicate sharding function

**Function Entry**: Select "Configuration" -\> "Sharding Function" -\> "Replication![](media/image197.png){width="0.2798611111111111in" height="0.34930555555555554in"}" on the Distributed Transactional Database Platform page.
...
![](media/image198.png){width="1.94375in" height="1.1958333333333333in"}
...
![](media/image199.png){width="5.769444444444445in" height="1.6222222222222222in"}
...
DR mode explanation: when the DR mode is enabled, please refer to the chapter \"Config checking\" in the [Distributed Transactional Database HotDB Server - Cross-IDC Disaster Recovery Function Specification](../Distributed%20Transactional%20Database%20HotDB%20Server%20-%20Cross-IDC%20Disaster%20Recovery%20Function%20Specification.docx) for the relevant logical explanations of configuration checking.

**Function Entry**: Select "Configuration" -\> "Config Checking" on the Distributed Transactional Database Platform page.

![](media/image200.png){width="5.776388888888889in" height="3.433333333333333in"}
...
![](media/image201.png){width="5.7625in" height="7.077083333333333in"}
...
"k. After the global auto-increment and unique is enabled, bigint is the only type allowed for the auto-increment sequence in the table." is a newly added verification rule for management platforms of v.2.5.5 and above, as shown in the following figure:

![电脑屏幕的照片上写着字 描述已自动生成](media/image202.png){width="5.769444444444445in" height="1.601388888888889in"}
...
![手机屏幕的截图 描述已自动生成](media/image203.png){width="5.769444444444445in" height="2.6506944444444445in"}
...
![](media/image204.png){width="5.7625in" height="2.5875in"}

**Manual Backup**

![](media/image205.png){width="5.7625in" height="0.29375in"}
...
![](media/image206.png){width="5.769444444444445in" height="0.7625in"}
...
**Sign in without password**: If a remote server is connected through Sign in without password, all compute node servers are required to establish a password-free channel with the remote server. For the establishment of password-free channel, refer to the "Password-free Channel Description" chapter of the *Distributed Transactional Database HotDB Server \[Installation and Deployment\] Function Manual.*
...
![](media/image207.png){width="5.7625in" height="1.2097222222222221in"}

- Periodical Backup time can be set to 3 types: daily, weekly and monthly, but the "Cluster metadata backup and restore" function in HotDB Management can only add up to 6 periodical backup plans.
...
![](media/image208.png){width="5.769444444444445in" height="1.2097222222222221in"}
...
**DR mode explanation:** when the DR mode is enabled, please refer to the chapter \"Parameter configuration\" in the [Distributed Transactional Database HotDB Server - Cross-IDC Disaster Recovery Function Specification](../Distributed%20Transactional%20Database%20HotDB%20Server%20-%20Cross-IDC%20Disaster%20Recovery%20Function%20Specification.docx) for the relevant logical explanations of the parameter configuration.
...
![](media/image209.png){width="5.776388888888889in" height="1.6152777777777778in"}
...
![](media/image210.png){width="5.769444444444445in" height="2.104861111111111in"}
...
![黑色的屏幕 描述已自动生成](media/image211.png){width="5.769444444444445in" height="2.0in"}
...
![](media/image212.png){width="5.776388888888889in" height="2.2375in"}
...
![](media/image213.png){width="5.769444444444445in" height="1.636111111111111in"}
...
![黑色的屏幕 描述已自动生成](media/image214.png){width="5.769444444444445in" height="2.4402777777777778in"}
...
3. After clicking the ![](media/image215.png){width="0.20972222222222223in" height="0.22361111111111112in"} button, click the \[Reload\] button to re-enable the master configDB.

![黑色的屏幕 描述已自动生成](media/image216.png){width="5.769444444444445in" height="2.1465277777777776in"}
...
![电脑萤幕画面 描述已自动生成](media/image217.png){width="5.7625in" height="2.154166666666667in"}
...
![](media/image218.png){width="5.769444444444445in" height="1.1395833333333334in"}
...
![](media/image219.png){width="5.776388888888889in" height="1.9652777777777777in"}
...
![](media/image220.png){width="5.7625in" height="1.5451388888888888in"}
...
Select existing tables to configure privileges or add new table configuration and assign privileges. Select the logicDB and then select the table to be configured from the drop-down box or enter the name of new table. When clicking \[Confirm\], the page generates a configuration record.
...
![](media/image221.png){width="5.769444444444445in" height="0.8881944444444444in"}
...
test\@192.168.220.104 : TEST_ZY 08:54:51\> insert into join_cross_a\_jwy(adnid) value

(101);

Query OK, 1 row affected (0.05 sec)

test\@192.168.220.104 : TEST_ZY 08:56:11\> alter table join_cross_a\_jwy add column apassword int after aname;
...
![](media/image222.png){width="5.776388888888889in" height="2.307638888888889in"}

- Test user sets test_ct.test_temp table privileges denied DELETE, DROP

> ![](media/image223.png){width="5.7625in" height="1.5666666666666667in"}
...
test\@192.168.200.51 : test_ct 08:53:32\> insert into test2019(a) values(30);

Query OK, 1 row affected (0.09 sec)

test\@192.168.200.51 : test_ct 08:53:51\> delete from test2019 where a=30;

ERROR 1045 (HY000): \[DELETE\] command refused to user \'test\' to table \'TEST2019\' of logic database \'TEST_CT\'
...
![](media/image224.png){width="5.7625in" height="2.0701388888888888in"}
...
![](media/image225.png){width="5.769444444444445in" height="2.05625in"}
...
![](media/image226.png){width="5.7555555555555555in" height="3.209722222222222in"}
...
![](media/image227.png){width="5.7625in" height="3.1819444444444445in"}
...
![](media/image228.png){width="5.776388888888889in" height="3.4965277777777777in"}

- Login Method: Password and Sign in without password. If "Sign in without password" is selected, it needs to be set in advance. For details, refer to the "Instructions for Sign in without Password" module of the *Distributed Transactional Database HotDB Server \[Installation and Deployment\] Function Manual*.
...
![](media/image229.png){width="5.769444444444445in" height="3.321527777777778in"}
...
HotDB Management fully displays the physical and logic components such as front-end application, logicDB, compute node, data node, data source in the cluster in a visual mode. The QPS and connections on the component is dynamically generated through the front-end application connection pool and the back-end database connection pool information. "Logic Topological Graph" enables users to quickly understand the running status of the whole cluster and help users achieve efficient operation and maintenance.

**DR mode explanation:** when the DR mode is enabled, please refer to the chapter \"Logic topological graph\" in the [Distributed Transactional Database HotDB Server - Cross-IDC Disaster Recovery Function Specification](../Distributed%20Transactional%20Database%20HotDB%20Server%20-%20Cross-IDC%20Disaster%20Recovery%20Function%20Specification.docx) for the relevant logical explanations of the logic topological graph.

#### Topological graph component description

![](media/image230.png){width="5.7625in" height="2.8041666666666667in"}
...
![图片包含 电子, 电路, 电脑, 桌子 描述已自动生成](media/image231.png){width="5.440277777777778in" height="2.629166666666667in"}
...
![图片包含 电子, 电路, 电脑, 桌子 描述已自动生成](media/image232.png){width="5.727083333333334in" height="2.790277777777778in"}

3\) When the detection result of the selected node is \"consistent\": the master/slave data consistency will be shown as \"normal\".

![图片包含 电子, 电路, 电脑, 桌子 描述已自动生成](media/image233.png){width="5.7555555555555555in" height="2.776388888888889in"}
...
- ![](media/image234.png){width="0.3423611111111111in" height="0.2798611111111111in"} is a non-status icon, which connects one or two ConfigDBs ![](media/image235.png){width="0.3423611111111111in" height="0.30069444444444443in"}, respectively representing a single node ConfigDB and a master-master ConfigDB. In single-IDC mode, if three or more ConfigDBs are connected, it represents the ConfigDB in MGR mode. ![](media/image234.png){width="0.3423611111111111in" height="0.2798611111111111in"} will be in orange when all ConfigDBs are not available.
...
For more details about the components, please refer to the [Distributed Transactional Database HotDB Server \[Glossary\] Function Manual](file:////Users/anita/Desktop/未命名文件夹/Distributed%20Transactional%20Database%20HotDB%20Server%20-%20V2.5.3%20%5bGlossary%5d%20Function%20Manual.doc).
...
![](media/image236.png){width="5.769444444444445in" height="2.8319444444444444in"}
...
![](media/image237.png){width="5.769444444444445in" height="2.8604166666666666in"}
...
**DR mode explanation:** when the DR mode is enabled, please refer to the chapter \"Physical topological graph\" in the [Distributed Transactional Database HotDB Server - Cross-IDC Disaster Recovery Function Specification](../Distributed%20Transactional%20Database%20HotDB%20Server%20-%20Cross-IDC%20Disaster%20Recovery%20Function%20Specification.docx) for the relevant logical explanations of the physical topological graph.

**(1) Overview of physical topological graph**

![](media/image238.png){width="5.7625in" height="1.0277777777777777in"}
...
![](media/image239.png){width="5.7625in" height="2.845833333333333in"}
...
![](media/image240.png){width="2.986111111111111in" height="4.608333333333333in"}
...
![](media/image241.png){width="5.769444444444445in" height="1.1958333333333333in"}
...
![](media/image242.png){width="5.7625in" height="2.9298611111111112in"}
...
![](media/image243.png){width="5.7625in" height="3.4756944444444446in"}

- **Total Number of Client Connection**

It displays the number of connections actually established between the current "Front-end Application" and the compute node, in unit of pcs.

- **Thread Usage of Compute Nodes**

It displays the total number of threads, the occupied thread and the idle thread used by the current connection to the compute node, in unit of pcs.

- **Back-end Connection Status**

It displays the total number of threads, the occupied thread and the idle thread used by connection between the compute node and the back-end data source, in unit of pcs.

- **Direct Memory Usage of Compute Nodes**

It displays the current usage of direct memory configured by the compute node, shown as a percentage.

- **Real-time Data Amount**

It displays the monitoring of data amount in the cluster. It supports two statistical modes: line capacity and data capacity. The units of the line are 1, K and M adopting automatic carry, and the units of data capacity are 1byte, KB, MB and GB adopting automatic carry. The data of the whole cluster is monitored by default, and the monitoring dimension can also be added or adjusted in "Setting".

- **Heap Memory Usage of Compute Nodes**

It displays the current usage of heap memory configured by the compute node, shown as a percentage.

**(II) Compute node throughout**

![](media/image244.png){width="5.769444444444445in" height="3.3916666666666666in"}

- Network traffic monitoring

It displays the inflow and outflow of the whole cluster, including front-end traffic in/out and back-end traffic in/out in Bps.

- TPS

It displays the number of transactions executed per second for the whole cluster, in unit of pcs.

- QPS

It displays the number of queries per second for the whole cluster, in unit of pcs.

- Client operation rate

It displays the compute node operation throughput of the client in times/s, and monitors the whole cluster by default. The monitoring dimension can also be added or adjusted in "Setting".

- Back-end operation rate

It displays the operation throughput of compute node and back-end data source in times/s, and monitors the whole cluster by default. The monitoring dimension can also be added or adjusted in "Setting".

**(III) Compute node server resources**

![](media/image245.png){width="5.769444444444445in" height="3.202777777777778in"}

- **Server memory usage**

It displays the current memory usage of the server where the compute node is located. The total memory, used memory and remaining memory can be viewed. The server memory usage of master compute node is monitored by default, and the multi-node mode cluster can be switched to view other compute nodes in "Setting".

- **Server disk space usage**

It displays the current disk space usage of the server where the compute node is located. The total disk space, used disk space and remaining disk space can be viewed. The server disk space usage of master compute node is monitored by default, and the multi-node mode cluster can be switched to view other compute nodes in "Setting".

- **Server CPU load condition**

It displays the CPU load of the server where the compute node is located. The CPU load of master compute node is monitored by default, and the multi-node mode cluster can be switched to view other compute nodes in "Setting".

- **Server CPU usage**

It displays the CPU usage of the server where the compute node is located. By default, the CPU usage of master compute node is monitored by default, and the multi-node mode cluster can be switched to view other compute nodes in "Setting".

- **Server disk read/write status**

It displays the disk IO read/write status of the server where the compute node is located. The disk read/write status of master compute node is monitored by default, and the multi-node mode cluster can be switched to view other compute nodes in "Setting".

- **Server network traffic**

It displays the network traffic in/out of the server where the compute node is located, expressed in Bps. The network traffic in/out of master compute node is monitored by default, and the multi-node mode cluster can be switched to view other compute nodes in "Setting".

- **Server disk IO bandwidth usage**

It displays the disk IO bandwidth usage of the server where the compute node is located, expressed by a percent sign. The disk IO bandwidth usage of master compute node is monitored by default, and the multi-node mode cluster can be switched to view other compute nodes in "Setting".
...
![1E20BE4CD5EE19DD189AECC13BD3C15D](media/image246.png){width="5.740972222222222in" height="2.9090277777777778in"}
...
![](media/image247.png){width="5.7625in" height="2.797222222222222in"}
...
![](media/image248.png){width="5.769444444444445in" height="1.5104166666666667in"}
...
![](media/image249.png){width="5.7555555555555555in" height="2.4055555555555554in"}
...
- Display of data source: IP\_ Port\_ Data source name. It displays all data sources under the data node and identifies the current active data source. If the number of data sources exceeds five, only five data sources will be displayed. Click \"\>\> View more\" to jump to the data node details page.

![](media/image250.png){width="5.7555555555555555in" height="0.8041666666666667in"}
...
![](media/image251.png){width="5.7625in" height="1.5944444444444446in"}
...
![8757E7B41EC3A1B5168BEC310A6E1935](media/image252.png){width="5.769444444444445in" height="1.6645833333333333in"}
...
![](media/image253.png){width="5.7555555555555555in" height="1.6576388888888889in"}
...
![](media/image254.png){width="5.7555555555555555in" height="0.7833333333333333in"}
...
##### 15.3.4.1. Server performance

When the server SSH information is configured on the "Configuration -\> Server" page and the monitoring is enabled, the server resource details can be monitored in this monitoring panel. When the "Server" page is "Stopped" or the SSH configuration is "Removed", the monitoring page removes the server monitoring, the monitoring information is displayed in pages, and 5 records are displayed per page.

**(I) Page information description**

![](media/image255.png){width="5.769444444444445in" height="2.70625in"}

When there is a record of server not configured with SSH information on the "Configuration -\> Server" page, the monitoring page will provide a monitoring reminder, and server monitoring can be enabled by clicking the hyperlink to the "Server" configuration page.
...
![081150C702E5A4E269CFBBA7DD449A3E](media/image256.png){width="5.769444444444445in" height="2.9930555555555554in"}

![](media/image257.png){width="5.769444444444445in" height="5.041666666666667in"}
...
###### 15.3.4.2.1. Network quality topology {#network-quality-topology .list-paragraph}

![](media/image258.png){width="5.7625in" height="2.328472222222222in"}
...
![](media/image259.png){width="5.7625in" height="2.5805555555555557in"}
...
![](media/image260.png){width="5.7625in" height="2.6506944444444445in"}

###### 15.3.4.2.2. Network quality overview {#network-quality-overview .list-paragraph}
...
![](media/image261.png){width="5.7625in" height="2.3916666666666666in"}
...
![](media/image262.png){width="5.769444444444445in" height="1.5381944444444444in"}

###### 15.3.4.2.3. Network quality panel {#network-quality-panel .list-paragraph}
...
![](media/image263.png){width="5.769444444444445in" height="1.9930555555555556in"}

**Note:** the threshold displayed in the network quality monitoring should be set through Monitoring Panel Setting\>Cluster resource monitoring\>Network quality. The switch is OFF by default. When it is OFF, the data threshold warning will not be displayed. If the switch is ON, the page will display and judge according to the specific value in the threshold setting, as shown in the following figure:

![](media/image264.png){width="5.776388888888889in" height="1.2520833333333334in"}

![超出阈值（概览）](media/image265.png){width="5.776388888888889in" height="2.657638888888889in"}

###### 15.3.4.2.4. Cross-IDC network quality {#cross-idc-network-quality .list-paragraph}
...
![](media/image266.png){width="5.7625in" height="2.811111111111111in"}
...
![62995EFB07AA8B30F58275A4E2FA9051](media/image267.jpeg){width="5.7625in" height="3.0in"}

**IDC switching instructions:**

![](media/image268.png){width="5.7625in" height="2.811111111111111in"}
...
###### 14.3.4.2.5. Email alert of network quality {#email-alert-of-network-quality .list-paragraph}
...
![](media/image269.png){width="5.769444444444445in" height="2.1256944444444446in"}

![](media/image270.png){width="5.7625in" height="2.566666666666667in"}

###### 14.3.4.2.6. Network quality information collection {#network-quality-information-collection .list-paragraph}

Add network quality detection data through Tool -\> Information Collection.

![](media/image271.png){width="5.7625in" height="2.6152777777777776in"}

The detection data is added to the \"server related information. txt\" file in the corresponding server, as shown below:

![AB9432577A9DF59E5004057F7DDEEFDA](media/image272.png){width="5.05625in" height="5.580555555555556in"}
...
![](media/image273.png){width="5.776388888888889in" height="3.209722222222222in"}
...
![](media/image274.png){width="5.7625in" height="2.321527777777778in"}
...
This function is similar to the display processlist function of MySQL, which is used to view the current compute node server connection processing.

![](media/image275.png){width="5.769444444444445in" height="1.0277777777777777in"}
...
![](media/image276.png){width="5.2444444444444445in" height="1.7902777777777779in"}

If jing is entered, you cannot get the record information of user jing01.

![](media/image277.png){width="5.3284722222222225in" height="1.1819444444444445in"}

- After entering the search keywords in the box, click Search to trigger a filter query. Click \[Reset\] to clear the search box.

- After the display processlis query, move the mouse cursor into the header to display the comment information of the specific field.
...
![](media/image278.png){width="5.783333333333333in" height="1.4618055555555556in"}
...
![](media/image279.png){width="5.783333333333333in" height="2.0701388888888888in"}
...
- When moving the mouse cursor into the session link in the operation bar, the prompt is displayed as below. The Current Session Information display @\@session of the connection ID can be viewed. Click the link to obtain the connection ID of this record and jump to the session information viewing window.

![](media/image280.png){width="5.7555555555555555in" height="1.8319444444444444in"}![](media/image281.png){width="5.769444444444445in" height="1.7409722222222221in"}
...
![](media/image282.png){width="5.769444444444445in" height="1.4756944444444444in"}

- Click the \[Reset\] button to clear all values in the filter boxes.

![](media/image283.png){width="5.7625in" height="2.097916666666667in"}

- Click \[More\] to expand search fields:

![](media/image284.png){width="5.7625in" height="2.1118055555555557in"}
...
![](media/image285.png){width="5.769444444444445in" height="1.7201388888888889in"}

- When moving the mouse cursor into the connection, backend, and lastsql links in the operation bar, the following prompt is displayed: "View the Front-end Connection Status, Back-end Connection Status, and Finally Executed SQL corresponding to the session ID. Click the link to obtain the id value of this record and jump to display @\@connection;

- Click connection to obtain the id value of this record and jump to display @\@connection:

![](media/image286.png){width="5.7625in" height="1.5527777777777778in"}

- Click backend to obtain the bk_id field value and jump to display @\@backend

![](media/image287.png){width="5.769444444444445in" height="1.7902777777777779in"}

![](media/image288.png){width="5.7625in" height="1.8319444444444444in"}

- Click lastsql to obtain the bk_id field value and jump to display @\@lastsql:

![](media/image289.png){width="5.7625in" height="1.7625in"}

![](media/image290.png){width="5.769444444444445in" height="1.4333333333333333in"}
...
![](media/image291.png){width="5.7555555555555555in" height="2.307638888888889in"}
...
- When moving the mouse cursor into the session and lastsql links in the operation bar, the following prompt is displayed: "View the corresponding session information, view the finally executed SQL". click the link to obtain the id field value of this record and filter in the command "display @\@session, display @\@lastsql". (the bk_id in display@\@session record and the id in display@\@lastsql record correspond to it). Click the session button in the operation bar:

![](media/image292.png){width="5.7625in" height="1.8319444444444444in"}

![](media/image293.png){width="5.7625in" height="1.7201388888888889in"}

- Click the lastsql button in the operation bar:

![](media/image294.png){width="5.769444444444445in" height="1.8319444444444444in"}

![](media/image295.png){width="5.7625in" height="1.4618055555555556in"}
...
![](media/image296.png){width="5.783333333333333in" height="2.720138888888889in"}
...
![](media/image297.png){width="5.7625in" height="2.734027777777778in"}
...
![](media/image298.png){width="5.7625in" height="2.747916666666667in"}
...
![](media/image299.png){width="5.7625in" height="1.5527777777777778in"}
...
![](media/image300.png){width="5.7555555555555555in" height="1.9722222222222223in"}
...
![](media/image301.png){width="5.7625in" height="2.0416666666666665in"}
...
![](media/image302.png){width="5.7625in" height="2.209722222222222in"}
...
![](media/image303.png){width="5.7625in" height="1.6715277777777777in"}
...
![](media/image304.png){width="5.7625in" height="1.2520833333333334in"}
...
![](media/image305.png){width="5.7625in" height="2.1680555555555556in"}
...
![](media/image306.png){width="5.7625in" height="1.8458333333333334in"}

### JOIN correlation analysis

The "JOIN Correlation Analysis" function is to map the JOIN correlation diagram of the table in current business scenario by parsing the SQL statement in slow query log (i.e. Slow Query Log Analysis list data), thereby allowing users to have a global monitoring of the current business join table query JOIN. It also provides the cross-node cross JOIN correlation diagram, and users can pay attention to the current cross-node cross JOIN situation to optimize the table structure or the SQL query statement.

#### Prerequisites for use

To view the JOIN correlation diagram, the following prerequisites shall be met:

- The current user has the "Slow Query Log Analysis" menu privilege;
...
After selecting a logicDB and table name, all JOIN correlation diagrams (as shown below) or cross-node cross JOIN correlation diagrams can be viewed. The management platform refreshes the parse results at 0 a.m every day, or you can click ![](media/image307.png){width="0.20972222222222223in" height="0.20972222222222223in"} to manually refresh the parse results.

**Description of vertices and edges in the JOIN correlation diagram:**

- The vertexes represent tables and are divided into four colors according to the table type（![](media/image308.png){width="3.6083333333333334in" height="0.13958333333333334in"}）.
...
![](media/image309.png){width="5.776388888888889in" height="3.223611111111111in"}
...
- **JOIN Correlation Table:** A table with a JOIN correlation with the current table. The table name color is consistent with the vertex color according to the table type (![](media/image308.png){width="3.6083333333333334in" height="0.13958333333333334in"}). Click on the table name to jump to the JOIN Correlation Details page for the table.
...
![](media/image311.jpeg){width="5.769444444444445in" height="3.5104166666666665in"}
...
![](media/image312.jpeg){width="5.769444444444445in" height="3.5104166666666665in"}

![](media/image313.png){width="5.769444444444445in" height="2.0069444444444446in"}
...
The data volume distributions of data nodes, logicDB and tables for all members in the cluster are displayed in graph mode and report mode.
...
![](media/image314.png){width="5.7625in" height="3.573611111111111in"}
...
**(I) Cluster Data** **Amount Change Trend Chart**

![](media/image315.png){width="5.7625in" height="1.5805555555555555in"}
...
![](media/image316.png){width="4.013888888888889in" height="3.209722222222222in"}

![](media/image317.png){width="3.9722222222222223in" height="3.1680555555555556in"}
...
![](media/image318.png){width="3.986111111111111in" height="2.94375in"}

![](media/image319.png){width="3.986111111111111in" height="2.94375in"}
...
![](media/image320.png){width="3.9722222222222223in" height="2.94375in"}

![](media/image321.png){width="3.986111111111111in" height="2.9583333333333335in"}
...
![](media/image322.png){width="5.7625in" height="2.1819444444444445in"}
...
![](media/image323.png){width="5.7625in" height="3.5527777777777776in"}
...
![](media/image324.png){width="5.769444444444445in" height="1.5805555555555555in"}
...
![](media/image325.png){width="3.9583333333333335in" height="3.1958333333333333in"}
...
![](media/image326.png){width="3.9298611111111112in" height="2.9298611111111112in"}
...
- Click on a bar on the chart to enter the corresponding LogicDB Dimension Throughput Report.
...
![](media/image327.png){width="3.9298611111111112in" height="2.9298611111111112in"}
...
- Click on a table bar on the chart to enter the corresponding Table Dimension Throughput Report.

#### LogicDB Dimension Throughput Report

![](media/image328.png){width="5.769444444444445in" height="3.5527777777777776in"}
...
![](media/image329.png){width="5.7625in" height="3.5243055555555554in"}
...
![](media/image330.png){width="5.769444444444445in" height="2.8743055555555554in"}
...
![](media/image331.png){width="5.7625in" height="4.915972222222222in"}

**Total Data Node Throughput Comparison Chart**

![](media/image332.png){width="5.7625in" height="1.2520833333333334in"}
...
![](media/image333.png){width="5.7625in" height="1.4055555555555554in"}
...
![](media/image334.png){width="3.8319444444444444in" height="3.1819444444444445in"}
...
![](media/image335.png){width="3.8041666666666667in" height="2.94375in"}
...
![](media/image336.png){width="3.8180555555555555in" height="2.94375in"}
...
In addition to the "Graph Mode", Data Node Throughput can also view the SELECT, UPDATE, DELETE, INSERT and OTHER operations of each table in the whole cluster on each node through the "Table Mode".

![](media/image337.png){width="5.7555555555555555in" height="2.902083333333333in"}
...
![](media/image338.png){width="5.7625in" height="4.909027777777778in"}
...
**Connection with the longest connection duration**
...
**Note:** If the statistical units, that is, IP + LogicDB + connection users are consistent, it will be counted as a connection. Thus, the connection duration of A (this connection has 1000 concurrencies at the same time and each concurrency duration is 1 minute) may be longer than the connection duration of B (this connection has only one concurrency and the concurrency duration is one hour)

**Connection with the most operations**
...
**Connection with the most connection times**
...
**Proportion of total connection duration**
...
**Proportion of total connection times**
...
**Proportion of number of operations**
...
**Front-end application IP connection distribution map**
...
- The X-axis displays "Application Connection IP" by default. The horizontal coordinate can be switched to the "Connection User" or "LogicDB" dimension through the "Query by Connection Information" filter box. When modifying the X-axis to view dimensions, the chart title will also be switched accordingly.
...
**Connection user distribution map**
...
![](media/image339.png){width="5.769444444444445in" height="1.9583333333333333in"}
...
To use the data backup function of HotDB Management, it needs to install the HotDB Backup program on the server where the backed-up data source reside. For the installation and deployment of HotDB Backup, please refer to the backup program deployment chapter of Distributed Transactional Database HotDB Server \[Installation and Deployment\] Function Manual.

#### Manual backup

\(I\) Start backup

![](media/image340.png){width="5.7625in" height="2.013888888888889in"}

- Click "Manage -\> Data Backup -\> Backup Task -\> \[Start Backup\]" to manually start a backup task.

\(II\) Select backup method

![](media/image341.png){width="5.769444444444445in" height="1.7625in"}
...
![](media/image342.png){width="5.776388888888889in" height="3.747916666666667in"}
...
![](media/image343.png){width="5.783333333333333in" height="2.1819444444444445in"}
...
- Failed and invalid backup will be displayed in the backup list with the ![](media/image344.png){width="0.2375in" height="0.13958333333333334in"}and ![](media/image345.png){width="0.2520833333333333in" height="0.18194444444444444in"}marks. When moving the mouse cursor to them, the specific reason will be displayed.
...
![](media/image346.png){width="5.7625in" height="1.1118055555555555in"}

\(I\) Add backup plan

![](media/image347.png){width="5.7625in" height="2.5381944444444446in"}
...
![](media/image348.png){width="5.7555555555555555in" height="2.154166666666667in"}
...
SUPER,LOCK TABLES,REPLICATION SLAVE,REPLICATION CLIENT,TRIGGER,display VIEW,CREATE VIEW,CREATE ROUTINE,ALTER ROUTINE,EVENT ON \*.\* TO \'DBBACKUP\'@\'127.0.0.1\' IDENTIFIED BY \'DBBACKUP\';
...
![61217A6F2F883EF48CA1F249A1C831D2](media/image349.jpeg){width="5.7555555555555555in" height="4.958333333333333in"}

#### Start restore

![](media/image350.png){width="5.776388888888889in" height="2.895138888888889in"}
...
- You can also select to restore to any restorable time point after selecting \"restore to the user-defined time point\". For details, please refer to [(III) restore to the user-defined time point](#iii).
...
[]{#iii .anchor}**(III) Restore to the user-defined time point**

![](media/image351.png){width="5.776388888888889in" height="3.1256944444444446in"}
...
![](media/image352.png){width="5.7625in" height="1.1118055555555555in"}

![](media/image353.png){width="5.7555555555555555in" height="1.1541666666666666in"}
...
![](media/image354.png){width="5.7625in" height="3.013888888888889in"}
...
![](media/image355.png){width="5.356944444444444in" height="2.6083333333333334in"}
...
DR mode explanation: when the DR mode is enabled, please refer to the chapter \"Data source migration\" in the [Distributed Transactional Database HotDB Server - Cross-IDC Disaster Recovery Function Specification](../Distributed%20Transactional%20Database%20HotDB%20Server%20-%20Cross-IDC%20Disaster%20Recovery%20Function%20Specification.docx) for the relevant logical explanations of the data source migration.

#### Data source migration preparation

![](media/image356.png){width="5.769444444444445in" height="2.5805555555555557in"}
...
![](media/image357.png){width="5.7625in" height="2.321527777777778in"}

![](media/image358.png){width="5.601388888888889in" height="2.3777777777777778in"}
...
![](media/image359.png){width="5.398611111111111in" height="3.279861111111111in"}
...
![](media/image360.png){width="5.7625in" height="3.545138888888889in"}
...
![](media/image361.png){width="5.769444444444445in" height="2.7694444444444444in"}
...
![](media/image362.png){width="5.769444444444445in" height="1.1680555555555556in"}
...
![](media/image363.png){width="5.7625in" height="0.9159722222222222in"}
...
![](media/image364.png){width="5.783333333333333in" height="1.2798611111111111in"}

- Data Source Migration completed is also displayed in the "Notice".

![](media/image365.png){width="4.2659722222222225in" height="2.5944444444444446in"}

### Table structure change

HotDB Management provides users with an entry point to execute DDL statements online through the "Table Structure Change" function. At the same time, the online DDL mode can also be selected when performing DDL operations on business tables with large amount of data.

#### Ordinary DDL

Ordinary DDL is a data definition type statement, such as CREATE\\DROP\\TRUNCATE\\RENAME.

![](media/image366.png){width="5.769444444444445in" height="2.4618055555555554in"}
...
Note: When selecting the compute node database user for login, the set "host" range must include the IP address of the server to which the current HotDB Management belongs. Otherwise, the compute node cannot be connected.
...
![](media/image367.png){width="5.7625in" height="1.601388888888889in"}
...
![](media/image368.png){width="5.7625in" height="3.0277777777777777in"}
...
![](media/image369.png){width="5.7625in" height="2.454861111111111in"}
...
![](media/image370.png){width="5.769444444444445in" height="1.94375in"}
...
![](media/image371.png){width="5.783333333333333in" height="2.4472222222222224in"}
...
- The task record can be filtered by "LogicDB", "Table Name", and "Status".

- The task record "Status" usually includes 9 types, which are:

> A. Successful: The task is completed normally without data inconsistency.
>
> B. Successful![](media/image372.png){width="0.18194444444444444in" height="0.15416666666666667in"}: The task is completed normally with some inconsistent data automatically restored by the program. The warning sign displays: "The data consistency detection after the change found that a small amount of data is inconsistent and has been automatically restored by the program".
>
> C. Successful![](media/image372.png){width="0.18194444444444444in" height="0.15416666666666667in"}: The task is completed normally and the inconsistent data is fixed by the program, but there are still some inconsistencies, and the user chooses to ignore the inconsistent data and complete the modification task. The warning tag prompts: "After the program automatically has restored the inconsistent data, the data still has inconsistencies, and the user chooses to allow partial data inconsistency".
>
> D. Failed![](media/image373.png){width="0.11180555555555556in" height="0.11180555555555556in"}: The task fails because the user manually cancels the task. Error mark prompts: "Manually cancel modification task execution".
>
> E. Failed![](media/image373.png){width="0.11180555555555556in" height="0.11180555555555556in"}: The task fails because the data inconsistency still exists after automatic restore by the program, and the user chooses to abandon this modification task. Error tag prompts: "data inconsistency still exists after automatic restore by the program, and the user chooses to abandon this modification task".
>
> F. Failed![](media/image373.png){width="0.11180555555555556in" height="0.11180555555555556in"}: The task fails because the data is found inconsistent after the change is completed and data inconsistency still exists after automatic restore by the program which shall be confirmed by the user. The user fails to process within the set waiting time which causes the task to fail. Error tag prompts: "The data inconsistency has not been processed within the set time range, and the modification task automatically fails".
>
> G. Failed![](media/image373.png){width="0.11180555555555556in" height="0.11180555555555556in"}: The task fails because the modification plan fails the "modification plan Pre-check" after the task is started in batches. Error tag prompts: "After the task is started in batches, the modification plan fails the pre-check, causing the task to fail.\"
>
> H. Waiting: The task is not completed, and data inconsistency needs to be confirmed by the user. Warning tag prompts: "Inconsistent data still exists after the program automatically has restored the inconsistent data, waiting for the user to confirm and process".
>
> I. Pause![](media/image374.png){width="0.33541666666666664in" height="0.34930555555555554in"}: After the task is started, because the user sets the pause replication period, after the task enters the period, the page displays the task status as Pause, and "The modification task is in the pause data replication period" is prompted when moving the mouse cursor into it.

#### Start modification task

![](media/image375.png){width="5.7625in" height="1.0138888888888888in"}
...
![](media/image376.png){width="5.7625in" height="3.5104166666666665in"}
...
![](media/image377.png){width="5.7625in" height="3.0in"}
...
If "Open Global Unique Constraint" in "Fill in Modification Plan" is checked, the modification plan pre-detection will detect whether the historical data of the source table unique constraint key is unique. If it is not checked or the changed table is not a sharding table, the item passes directly without detection.
...
![](media/image378.png){width="5.7555555555555555in" height="3.4055555555555554in"}

- The source table configuration and modification plan information cannot be modified. If modification is needed, click \[Previous Step\] to return to the "Fill in Modification Plan", and perform a detection after the modification.
...
![](media/image379.png){width="5.7555555555555555in" height="2.4895833333333335in"}
...
![](media/image380.png){width="5.7555555555555555in" height="1.1118055555555555in"}
...
![](media/image381.png){width="5.769444444444445in" height="1.363888888888889in"}
...
![](media/image382.png){width="5.7625in" height="3.790277777777778in"}
...
![](media/image383.png){width="5.7625in" height="4.524305555555555in"}
...
![](media/image384.png){width="5.7625in" height="3.845833333333333in"}
...
![](media/image385.png){width="5.7625in" height="4.0in"}
...
![](media/image386.png){width="5.7625in" height="3.9722222222222223in"}
...
![](media/image387.png){width="5.783333333333333in" height="3.9722222222222223in"}
...
![](media/image388.png){width="5.769444444444445in" height="2.0840277777777776in"}
...
![QQ20200528-0](media/image389.jpeg){width="5.769444444444445in" height="1.0770833333333334in"}
...
![](media/image390.png){width="5.769444444444445in" height="1.5666666666666667in"}
...
![](media/image391.png){width="5.776388888888889in" height="2.259027777777778in"}
...
![](media/image392.png){width="5.769444444444445in" height="1.0979166666666667in"}
...
![](media/image393.png){width="5.769444444444445in" height="1.46875in"}
...
![](media/image394.png){width="5.776388888888889in" height="2.3354166666666667in"}
...
![](media/image395.png){width="5.769444444444445in" height="1.29375in"}
...
![](media/image396.png){width="5.769444444444445in" height="1.6576388888888889in"}
...
![](media/image397.png){width="5.769444444444445in" height="2.2868055555555555in"}
...
![](media/image398.png){width="5.769444444444445in" height="1.29375in"}
...
![](media/image399.png){width="5.769444444444445in" height="1.6715277777777777in"}
...
![](media/image400.png){width="5.769444444444445in" height="2.2375in"}
...
![](media/image401.png){width="5.769444444444445in" height="1.4194444444444445in"}
...
![](media/image405.png){width="5.783333333333333in" height="0.70625in"}
...
![](media/image406.png){width="5.769444444444445in" height="0.7270833333333333in"}
...
![](media/image407.png){width="5.769444444444445in" height="0.6923611111111111in"}
...
![](media/image408.png){width="5.776388888888889in" height="0.7131944444444445in"}
...
![](media/image409.png){width="5.769444444444445in" height="1.1256944444444446in"}

- Table with foreign key relation, if data status is normal, will reestablish the foreign key relation after restore.

#### History record

![](media/image410.png){width="5.769444444444445in" height="1.5173611111111112in"}

![](media/image411.png){width="5.783333333333333in" height="2.1326388888888888in"}

- Click History Record on the "Management -\> Table Recycle Bin" page to enter the table recycle bin operation history page.

- You can view the history record by filtering through LogicDB and original table name.

#### Delete history record

![](media/image412.png){width="5.7625in" height="1.1256944444444446in"}
...
![](media/image413.png){width="5.769444444444445in" height="2.2375in"}

- To use the white list function, it needs to enable the white list switch in "Security-\>White list" first.

- It needs to use "Reload" to enable or disable the white list or to add, modify or delete white list information.
...
The "SQL Firewall" function provided by HotDB Management can intercept high-risk SQL, mis-operation SQL, etc. for users to improve system security.

![](media/image414.png){width="5.769444444444445in" height="2.426388888888889in"}
...
A single or batch can be enabled or disabled through "Reload". If the intercepted SQL is executed in the compute node after it takes effect, it will prompt "ERROR 10029 (HY000): You are using SQL Firewall, this sql isn\'t allowed".
...
![电脑屏幕截图 描述已自动生成](media/image415.png){width="5.7625in" height="2.0347222222222223in"}
...
![屏幕的截图 描述已自动生成](media/image416.png){width="5.7625in" height="1.2729166666666667in"}
...
![](media/image417.png){width="5.7625in" height="0.37777777777777777in"}

At the same time, you can see the relevant interception log through Event -\> Audit logs -\> safety protection:

![电脑萤幕截图 描述已自动生成](media/image418.png){width="5.7625in" height="1.9722222222222223in"}
...
![](media/image420.png){width="5.7625in" height="1.8180555555555555in"}
...
Modifying the password of the exclusive user **root** account of HotDB Management connecting compute nodes requires the automatic execution of "Reload". If Reload fails, the password modification operation also fails synchronously.
...
![](media/image421.png){width="5.7625in" height="2.8180555555555555in"}
...
![](media/image422.png){width="5.7625in" height="1.8743055555555554in"}
...
**DR mode explanation:** when the DR mode is enabled, please refer to the chapter \" Master/Slave data consistency detection \" in the [Distributed Transactional Database HotDB Server - Cross-IDC Disaster Recovery Function Specification](../Distributed%20Transactional%20Database%20HotDB%20Server%20-%20Cross-IDC%20Disaster%20Recovery%20Function%20Specification.docx) for the relevant logical explanations of the master/slave data consistency detection.

#### Start a detection

![](media/image423.png){width="5.776388888888889in" height="3.657638888888889in"}
...
![](media/image424.png){width="5.769444444444445in" height="2.3493055555555555in"}
...
- If data node of the detected table is not configured with the corresponding \"switching rule\" or data source of the detected table is unavailable, the master/slave consistency detection cannot be performed for the table.

![](media/image425.png){width="5.769444444444445in" height="1.6222222222222222in"}
...
![](media/image426.png){width="5.7625in" height="3.6506944444444445in"}
...
![](media/image427.png){width="5.7625in" height="2.5104166666666665in"}
...
![](media/image428.png){width="5.7625in" height="2.6152777777777776in"}

![](media/image429.png){width="5.783333333333333in" height="1.426388888888889in"}
...
![](media/image430.png){width="5.7625in" height="4.622222222222222in"}
...
For the global table data detection periodical plan, please refer to the Periodical Plan description in "Master/Slave Data Consistency Detection".
...
![](media/image431.png){width="5.776388888888889in" height="3.657638888888889in"}
...
- Detection tasks can be executed automatically by adding a periodical plan. For introduction of periodical plan, please refer to the Periodical Plan description in "Master/Slave Data Consistency Detection".
...
![](media/image432.png){width="5.769444444444445in" height="2.9791666666666665in"}
...
- %s(%s), this index was not used when it was detected. It is recommended to optimize this index after checking.
...
![蓝色屏幕的截图 描述已自动生成](media/image433.png){width="5.769444444444445in" height="1.3354166666666667in"}
...
![](media/image434.png){width="5.7625in" height="3.1465277777777776in"}
...
![](media/image435.png){width="5.7555555555555555in" height="3.4618055555555554in"}
...
![](media/image436.png){width="5.769444444444445in" height="2.0416666666666665in"}
...
![](media/image437.png){width="5.7555555555555555in" height="2.0701388888888888in"}
...
![](media/image438.png){width="5.7625in" height="1.8180555555555555in"}
...
![](media/image439.png){width="5.7625in" height="2.259027777777778in"}
...
![](media/image440.png){width="5.783333333333333in" height="2.321527777777778in"}
...
![](media/image441.png){width="5.7625in" height="1.7763888888888888in"}
...
![](media/image442.png){width="5.0in" height="0.2375in"}

![](media/image443.png){width="5.7625in" height="1.8604166666666666in"}

#### Route abnormal details

![](media/image444.png){width="5.769444444444445in" height="1.1395833333333334in"}
...
![](media/image445.png){width="5.7625in" height="3.636111111111111in"}
...
3\. Click \[Delete Record\] to delete the history detection record on the page. If the record has a result file generated during detection (when the details of detection results exceed 2048 bytes, the results are saved in the form of a file), the corresponding file will be deleted.

#### Detection record details

![](media/image446.png){width="5.769444444444445in" height="3.6506944444444445in"}
...
![](media/image447.png){width="5.769444444444445in" height="1.1819444444444445in"}
...
![](media/image448.png){width="5.783333333333333in" height="2.776388888888889in"}
...
![](media/image449.png){width="5.7625in" height="2.678472222222222in"}
...
+---------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| HOTDBERROR                | Record the custom ERROR of compute node. For details, please refer to *Distributed Transactional Database HotDB Server \[Compute Node Error Code\]*                                                                                                     |
+---------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| HOTDBWARNING              | Record the custom WARNING of compute node. For details, please refer to *Distributed Transactional Database HotDB Server \[Compute Node Error Code\]*                                                                                                   |
+---------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+---------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| SWITCHSOURCE              | Record log information related to the data correctness guarantee after failover. For details, please refer to the "Data Correctness Guarantee after Failover" chapter of *Distributed Transactional Database HotDB Server \[Standard\] Function Manual* |
+---------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
![](media/image450.png){width="5.7625in" height="3.6506944444444445in"}
...
(I) **Compute time distribution**

![](media/image451.png){width="5.769444444444445in" height="3.0208333333333335in"}
...
(II) **SQL to be optimized**

![810B05BBED0E098CE44C0C44A5FF5B2A](media/image452.png){width="5.811111111111111in" height="2.433333333333333in"}
...
![](media/image453.png){width="5.776388888888889in" height="2.4756944444444446in"}

(III) **SQL query optimization suggestions**

![](media/image454.png){width="5.776388888888889in" height="3.657638888888889in"}
...
>
> ![](media/image455.png){width="5.53125in" height="0.8673611111111111in"}

(IV) **Average execution time is too long**

![37D60868EBE18436D6E0C7051331F9D1](media/image456.png){width="5.769444444444445in" height="3.0909722222222222in"}
...
![](media/image457.png){width="5.776388888888889in" height="2.482638888888889in"}
...
**Note:** host range set by User must contain IP address of the current HotDB Management service. Otherwise, the compute node cannot be connected normally.
...
- The execution plan will display the relative time point and time consumption (μ s) of each step. For details, please refer to the HotDB Profiles related sections in the [Distributed Transactional Database HotDB Server --\[Standard\] Function Manual](file:////Users/anita/Desktop/2.5.4/Distributed%20Transactional%20Database%20HotDB%20Server%20-%20V2.5.3.1%20%5bManagement%20Platform%5d%20Function%20Manual.doc).

![4CE82DC3D468183630C08824226B01DA](media/image458.png){width="5.769444444444445in" height="2.657638888888889in"}
...
![8936D4B3B5F4ECCF478E94BA6FED43AC](media/image459.png){width="5.7625in" height="3.433333333333333in"}
...
DR mode explanation: when the DR mode is enabled, please refer to the chapter \"Notification strategy\" in the [Distributed Transactional Database HotDB Server - Cross-IDC Disaster Recovery Function Specification](../Distributed%20Transactional%20Database%20HotDB%20Server%20-%20Cross-IDC%20Disaster%20Recovery%20Function%20Specification.docx) for the relevant logical explanations of the notification strategy.

#### Add notification strategy

![](media/image460.png){width="5.776388888888889in" height="3.657638888888889in"}

![](media/image461.png){width="5.776388888888889in" height="2.482638888888889in"}
...
(1) To perform the email reminder of the corresponding item, it shall first ensure that the monitoring item has been opened in the Setting. Otherwise, the email cannot prompt the alert notification of the monitoring item (the monitoring item can be opened in the "Setting" menu, and the alert value of the corresponding item can be customized).
...
![](media/image462.png){width="5.776388888888889in" height="0.70625in"}

**Email example**: The prompt information for compute node service failure or switching is as follows:

![FD89DA56B1D57862B11ABC39BEC08D27](media/image463.jpeg){width="5.7625in" height="1.0in"}

**Email example**: The prompt information for data source service failure or switching is as follows:

![](media/image464.png){width="5.7625in" height="1.1118055555555555in"}

##### (II) Compute node service resource monitoring {#ii-compute-node-service-resource-monitoring .list-paragraph}
...
![](media/image465.png){width="5.769444444444445in" height="0.8388888888888889in"}
...
![](media/image466.png){width="5.7625in" height="3.70625in"}
...
![](media/image467.png){width="5.7625in" height="2.678472222222222in"}
...
![](media/image468.png){width="5.769444444444445in" height="0.7902777777777777in"}
...
![](media/image469.png){width="5.776388888888889in" height="3.70625in"}

**Note**: The above thresholds are the test environment settings and are for reference only.

**Email example**: The prompt information of compute node service status monitoring alert reminder is as follows:

![](media/image470.png){width="5.7625in" height="5.3493055555555555in"}
...
![](media/image471.png){width="5.7555555555555555in" height="0.7625in"}

**Threshold setting:** To monitor the corresponding item of the compute node service resources, it shall be ensured that the monitoring item has been opened in "Setting -\> [Monitoring Panel Setting](#monitoring-panel-setting)" and "Setting -\> [Periodical Detection Setting](#periodical-detection-setting-1)" and the corresponding thresholds have been set, as shown below:

![](media/image472.png){width="5.769444444444445in" height="3.3916666666666666in"}

**Note**: The above thresholds are the test environment settings and are for reference only..

**Email example**: The prompt information of other server resource monitoring exception reminder is as follows:

![](media/image473.png){width="5.7625in" height="1.9722222222222223in"}
...
![](media/image474.png){width="5.776388888888889in" height="0.6222222222222222in"}

**Threshold setting**: To monitor the corresponding item of the data source, it shall be ensured that the monitoring item has been opened in "Setting -\> [Topological Graph Alert Setting]{.ul}" and the corresponding thresholds have been set, as shown below:

![](media/image475.png){width="5.783333333333333in" height="4.790277777777778in"}

**Note**: The above thresholds are the test environment settings and are for reference only.

**Email example**: The prompt information of data source related monitoring alert reminder is as follows:

![](media/image476.png){width="5.7625in" height="1.3076388888888888in"}

##### （VI）ConfigDB monitoring

**Description:** the ConfigDB monitoring notification takes the latest exception within the notification time.

![](media/image477.png){width="5.769444444444445in" height="0.33541666666666664in"}
...
![2D4F6DB85FDEBC243C8CA72CE204B994](media/image478.png){width="5.7625in" height="4.370833333333334in"}

**Note:** the above thresholds are set for the test environment and are for reference only.

**Email example:** ConfigDB monitoring alert reminders; the prompt information is as follows:

![F4BF5523AE2BE93AD9DD190380F2F428](media/image479.png){width="5.769444444444445in" height="2.454861111111111in"}
...
![](media/image480.png){width="5.7625in" height="0.7479166666666667in"}

**Threshold setting**: To monitor the corresponding item of the data source, it shall be ensured that the monitoring item has been opened in "Setting -\> [Periodical Detection Setting]{.ul}" and the corresponding thresholds have been set, as shown below:

![](media/image481.png){width="5.7625in" height="2.1958333333333333in"}

**Note**: The above thresholds are the test environment settings and are for reference only.

![](media/image482.png){width="5.769444444444445in" height="1.3916666666666666in"}
...
![](media/image483.png){width="5.7625in" height="0.41944444444444445in"}
...
![](media/image490.png){width="5.7625in" height="1.070138888888889in"}
...
![](media/image491.png){width="5.7625in" height="2.776388888888889in"}
...
![](media/image492.png){width="5.783333333333333in" height="2.790277777777778in"}
...
![](media/image493.png){width="5.7625in" height="2.776388888888889in"}
...
![](media/image494.png){width="5.776388888888889in" height="2.6645833333333333in"}
...
![](media/image495.png){width="5.783333333333333in" height="3.5034722222222223in"}
...
![](media/image496.png){width="5.769444444444445in" height="5.377777777777778in"}

### Monitoring panel setting

It is used to enable or disable the monitoring items of "Compute Node Service Status", "Compute Node Traffic", "Compute Node Server Resource" and "Other Server Resources" panels in "Monitoring-\>Monitoring Panel". the data refresh frequency and the server parameter status threshold can also be set.

![](media/image497.png){width="5.7625in" height="7.831944444444445in"}

![](media/image498.png){width="5.776388888888889in" height="3.6506944444444445in"}

![](media/image499.png){width="5.7625in" height="3.265972222222222in"}
...
![](media/image500.png){width="5.783333333333333in" height="2.845833333333333in"}

### Notification setting

It sets the email sender parameter of email alert function in "Event-\>Notification Strategy" and the monitoring switch and frequency of monitoring item.
...
![](media/image501.png){width="5.7625in" height="2.671527777777778in"}
...
![](media/image502.png){width="4.111805555555556in" height="2.8604166666666666in"}
...
![](media/image503.png){width="4.279861111111111in" height="2.9159722222222224in"}

- Mail Test content is as shown below:

![](media/image504.png){width="5.769444444444445in" height="1.0138888888888888in"}
...
![](media/image505.png){width="5.776388888888889in" height="3.6013888888888888in"}
...
![](media/image506.png){width="5.769444444444445in" height="2.692361111111111in"}
...
![](media/image507.png){width="5.783333333333333in" height="3.0840277777777776in"}
...
4\. Pay attention to the task execution on the "Tool" -\> "Data Collection" -\> "Record" page.
...
![](media/image508.png){width="5.7625in" height="1.5034722222222223in"}
...
![](media/image509.png){width="5.776388888888889in" height="2.671527777777778in"}
...
**Function entry:** enter the Business data reporting page through \"Tool\" - \> \"Business data reporting\" on the management platform, as shown in the following figure:

![电脑萤幕画面 描述已自动生成](media/image510.png){width="5.7625in" height="2.9159722222222224in"}
...
![电脑萤幕的截图 描述已自动生成](media/image511.png){width="5.7625in" height="1.5381944444444444in"}
...
![电脑萤幕的截图 描述已自动生成](media/image512.png){width="5.7625in" height="1.2868055555555555in"}
...
![DFE2E1DCF1062282E210F8EE8258D231](media/image513.png){width="5.7625in" height="0.7340277777777777in"}
...
![](media/image514.png){width="5.7625in" height="0.6222222222222222in"}
...
![图片包含 黑暗, 灯光, 水, 蓝色 描述已自动生成](media/image515.png){width="5.7625in" height="1.0416666666666667in"}
...
![截图里有图片 描述已自动生成](media/image516.png){width="5.7625in" height="1.2027777777777777in"}
...
![电脑萤幕的截图 描述已自动生成](media/image517.png){width="5.7625in" height="2.692361111111111in"}
...
![](media/image518.png){width="5.7625in" height="0.44722222222222224in"}
...
![手机屏幕截图 描述已自动生成](media/image519.png){width="5.7625in" height="0.9020833333333333in"}
...
![手机屏幕截图 描述已自动生成](media/image520.png){width="5.7625in" height="0.9861111111111112in"}
...
![截图里有图片 描述已自动生成](media/image521.png){width="5.7625in" height="0.9159722222222222in"}
...
![电脑萤幕的截图 描述已自动生成](media/image522.png){width="5.7625in" height="1.2027777777777777in"}
...
![](media/image523.png){width="5.7625in" height="0.4618055555555556in"}
...
![](media/image524.png){width="5.7625in" height="0.4263888888888889in"}
...
![](media/image525.png){width="5.7625in" height="0.5451388888888888in"}
...
For details, you can refer to the [Distributed Transactional Database HotDB Server - V2.5.6 \[Intelligent Inspection\] Function Manual](file:////Users/anita/Desktop/最新英文版/Distributed%20Transactional%20Database%20HotDB%20Server%20-%20V2.5.6%20%5bStandard%5d%20Function%20Manual.doc).
...
![](media/image526.png){width="5.7555555555555555in" height="1.1680555555555556in"}

### Version

![](media/image527.png){width="5.769444444444445in" height="1.1958333333333333in"}
...
![](media/image528.png){width="5.7625in" height="1.8041666666666667in"}
...
![](media/image529.png){width="5.7625in" height="2.7625in"}
...
![4C2ABF6025081088BCB394353295EA1D](media/image530.jpeg){width="5.7625in" height="1.9722222222222223in"}
...
![](media/image531.png){width="5.7625in" height="1.7763888888888888in"}

![](media/image532.png){width="5.7625in" height="2.154166666666667in"}

### Reload

#### Reload instructions

**Description**: When the compute node related configDB parameters are modified in HotDB Management, the modified parameters shall be synchronized to the memory of compute node through the "Reload" function to take effect immediately. Currently, only some parameters support Reload.
...
![](media/image533.png){width="5.7625in" height="1.7763888888888888in"}
...
![DG1F)0GN\[OEC2\~XS\[QN\@ACL](media/image534.jpeg){width="5.769444444444445in" height="2.902083333333333in"}
...
![](media/image535.png){width="5.7625in" height="1.7763888888888888in"}
...
![](media/image536.png){width="3.8041666666666667in" height="1.4618055555555556in"}
...
![](media/image537.png){width="3.8041666666666667in" height="1.8743055555555554in"}
...
![](media/image538.png){width="5.769444444444445in" height="2.986111111111111in"}

#### Reload triggering scenario

![](media/image539.png){width="5.769444444444445in" height="2.5243055555555554in"}
...
![](media/image540.png){width="5.7625in" height="1.7763888888888888in"}

- The content of notice is consistent with the content of "Event" on the "Home".

- Click on the specific event in the Notice to jump to "Event -\> History Event" or specific function to view the details.

- The Notice content is divided into three levels: ERROR, WARNING and INFO, displayed with the icons of ![](media/image541.png){width="0.39166666666666666in" height="0.41944444444444445in"}, ![](media/image542.png){width="0.4618055555555556in" height="0.41944444444444445in"} and ![](media/image543.png){width="0.44722222222222224in" height="0.4618055555555556in"} respectively.
...
![](media/image544.png){width="5.7625in" height="1.7763888888888888in"}
...
![](media/image545.png){width="5.7625in" height="1.7625in"}
...
![](media/image546.png){width="5.783333333333333in" height="2.8881944444444443in"}

- High-risk operation qualification switch requires password checking by users when it is turned on or off.

![](media/image547.png){width="5.747916666666667in" height="3.05625in"}
...
![](media/image548.png){width="5.7625in" height="2.4194444444444443in"}![](media/image549.png){width="5.223611111111111in" height="3.7625in"}
...
![](media/image550.png){width="5.776388888888889in" height="1.7625in"}
...
![](media/image551.png){width="5.769444444444445in" height="1.4548611111111112in"}
...
![](media/image552.png){width="3.636111111111111in" height="1.7409722222222221in"}

![](media/image553.png){width="3.657638888888889in" height="1.601388888888889in"}

![](media/image554.png){width="5.776388888888889in" height="3.6152777777777776in"}
...
> ![](media/image555.png){width="5.776388888888889in" height="0.7694444444444445in"}
>
> ![](media/image556.png){width="5.776388888888889in" height="2.104861111111111in"}
>
> ![](media/image554.png){width="5.776388888888889in" height="3.6152777777777776in"}
