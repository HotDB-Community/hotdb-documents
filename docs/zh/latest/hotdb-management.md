...
本文主要描述HotDB Management配置操作流程以及相关功能说明，目的在于减少使用过程中的疑难点、降低沟通成本。本文档基于HotDB Management当前标识版本号编写，在正常部署HotDB Server和HotDB Management的环境基础上给予说明，部分截图包含HotDB Management版本以及细节差异无需特别关注，以文档描述的版本号为准。阅读本文档，可结合配套的[标准](standard.md)文档一起阅读，可帮助快速理解功能要点。
...
- 开启灾备模式并符合条件的集群，会现实【切换为主机房】、【移除机房】、【修复机房】等按钮，均可参考[可视化机房](visual-idc.md)文档
...
> !Note
>
> 其他更多灾备模式、多计算节点集群模式的添加注意事项，可查看[安装部署](installation-and-deployment.md)、[跨机房容灾](cross-idc-disaster-recovery.md)等其他配套文档。
...
普通用户登录HotDB Management成功后进入到集群选择页面。若开启灾备模式，集群选择页面展示以及逻辑说明请参照[跨机房容灾](cross-idc-disaster-recovery.md)文档中的"计算节点集群选择"章节。
...
若集群开启灾备模式，节点管理功能展示与操作说明请结合[跨机房容灾](cross-idc-disaster-recovery.md)文档中的[节点管理](cross-idc-disaster-recovery.md#节点管理)章节。
...
灾备模式说明：集群开启灾备模式时，配置校验相关逻辑说明请结合[跨机房容灾](cross-idc-disaster-recovery.md)文档中的[配置校验](#配置校验)章节。
...
灾备模式说明：集群开启灾备模式时，计算节点参数配置相关逻辑说明也可结合[跨机房容灾](cross-idc-disaster-recovery.md)文档中的[计算节点参数配置](#计算节点参数配置)章节一起使用。
...
灾备模式说明：集群开启灾备模式时，智能逻辑拓扑图相关逻辑说明请结合[跨机房容灾](cross-idc-disaster-recovery.md)文档中的"智能逻辑拓扑图"章节。
...
灾备模式说明：集群开启灾备模式时，智能物理拓扑图相关逻辑说明请结合[跨机房容灾](cross-idc-disaster-recovery.md)文档中的"智能物理拓扑图"章节。
...
灾备模式说明：集群开启灾备模式时，数据备份相关逻辑说明请结合[跨机房容灾](cross-idc-disaster-recovery.md)文档中的[数据备份](#数据备份)章节。
...
灾备模式说明：集群开启灾备模式时，一键迁库相关逻辑说明请结合[跨机房容灾](cross-idc-disaster-recovery.md)文档中的[一键迁库](cross-idc-disaster-recovery.md#一键迁库)章节。
...
**灾备模式说明：**集群开启灾备模式时，主备数据一致性检测相关逻辑说明请结合[跨机房容灾](cross-idc-disaster-recovery.md)中的[主备数据一致性检测](#主备数据一致性检测)章节。
...
灾备模式说明：集群开启灾备模式时，通知策略相关逻辑说明请结合[跨机房容灾](cross-idc-disaster-recovery.md)文档中的[通知策略](#通知策略)章节。
