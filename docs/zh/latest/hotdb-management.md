...
普通用户登录HotDB Management成功后进入到集群选择页面。若开启灾备模式，集群选择页面展示以及逻辑说明请参照[跨机房灾备](cross-idc-disaster-recovery.md)文档中的"计算节点集群选择"章节。
...
灾备模式说明：集群开启灾备模式时，配置校验相关逻辑说明请结合[跨机房灾备](cross-idc-disaster-recovery.md)文档中的[配置校验](#配置校验)章节。
...
灾备模式说明：集群开启灾备模式时，计算节点参数配置相关逻辑说明也可结合[跨机房灾备](cross-idc-disaster-recovery.md)文档中的[计算节点参数配置](#计算节点参数配置)章节一起使用。
...
灾备模式说明：集群开启灾备模式时，智能物理拓扑图相关逻辑说明请结合[跨机房灾备](cross-idc-disaster-recovery.md)文档中的"智能物理拓扑图"章节。
...
灾备模式说明：集群开启灾备模式时，数据备份相关逻辑说明请结合[跨机房灾备](cross-idc-disaster-recovery.md)文档中的[数据备份](#数据备份)章节。
